//
//  S_PlayerEffectView.swift
//  Singer
//
//  Created by Bruce on 16/8/4.
//  Copyright © 2016年 Bruce. All rights reserved.
//

import UIKit

class S_PlayerEffectView: UIView {

    override init(frame: CGRect) {
        super.init(frame: frame)
//        CGRect(x: 0.0, y: -70.0, width: view.bounds.width,height: 50.0)
        let rect = CGRect(x: 0.0, y: 0.0, width: SCREEN_WIDTH,height: 50.0)
        ...
        emitterCell.birthRate = 10  //每秒产生10个粒子
